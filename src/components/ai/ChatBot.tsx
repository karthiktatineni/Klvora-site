    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed bottom-6 right-6 w-[400px] max-h-[600px] flex flex-col bg-white rounded-2xl shadow-cinematic border border-outline-variant/20 z-[100] overflow-hidden"
        >
          {/* Header */}
          <div className="p-6 border-b border-outline-variant/10 flex items-center justify-between bg-white">
